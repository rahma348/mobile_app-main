    ...
    SingleChildScrollView(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isUser ? const Color(0xff0C8A7D) : Colors.grey.shade300,
        ...
        Column(
          ...
          children: [
            ...
            Text(
              message,
              style: TextStyle(
                  color: isUser ? Colors.white : Colors.black, fontSize: 20),
            ),
            Text(
              date,
              style: TextStyle(
                  color: isUser ? Colors.white : Colors.black, fontSize: 14),
            ),
          ],
        ),
      ),
